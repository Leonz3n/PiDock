...
先完成 01，再按依赖推进。16–19 已补齐，19 可与 18 并行，最终由 15 联合验收。工单发布不代表实现已开始。运行时与界面栈已确认（Bun ＋ React／Tailwind／TanStack，见规格「技术栈与运行时」）；Electron 主进程仍运行内置 Node，Bun 只覆盖 Host 与工具链。
