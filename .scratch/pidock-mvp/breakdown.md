...
先完成 01，再按依赖推进。16–19 已补齐，19 可与 18 并行，20 可与 01 并行，最终由 15 联合验收。工单发布不代表实现已开始。运行时与桌面壳已确认（Bun 主进程 ＋ Electrobun ＋ React／Tailwind／TanStack，见规格「技术栈与运行时」）；Electron 仅在 01 的决策关卡触发时作为回退方案。
